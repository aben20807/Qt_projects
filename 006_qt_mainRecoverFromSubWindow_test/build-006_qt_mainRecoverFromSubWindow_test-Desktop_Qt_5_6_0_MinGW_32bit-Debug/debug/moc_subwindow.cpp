...
#include "../../006_qt_mainRecoverFromSubWindow_test/subwindow.h"
...
QT_MOC_LITERAL(1, 10, 8), // "close_me"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 11) // "close_child"

    },
    "SubWindow\0close_me\0\0close_child"
};
...
void SubWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubWindow::close_me)) {
                *result = 0;
                return;
            }
        }
