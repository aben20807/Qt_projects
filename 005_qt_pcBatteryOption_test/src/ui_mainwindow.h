...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        action0_1_s = new QAction(MainWindow);
        action0_1_s->setObjectName(QStringLiteral("action0_1_s"));
        action0_5_s = new QAction(MainWindow);
        action0_5_s->setObjectName(QStringLiteral("action0_5_s"));
        action1_0_s = new QAction(MainWindow);
        action1_0_s->setObjectName(QStringLiteral("action1_0_s"));
        action5_0_s = new QAction(MainWindow);
        action5_0_s->setObjectName(QStringLiteral("action5_0_s"));
        action10_s = new QAction(MainWindow);
        action10_s->setObjectName(QStringLiteral("action10_s"));
...
""));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        action0_1_s->setText(QApplication::translate("MainWindow", "0.1 s", 0));
        action0_5_s->setText(QApplication::translate("MainWindow", "0.5 s", 0));
        action1_0_s->setText(QApplication::translate("MainWindow", "1.0 s", 0));
        action5_0_s->setText(QApplication::translate("MainWindow", "5.0 s", 0));
